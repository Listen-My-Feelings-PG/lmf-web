...
export const httpRequestInterceptor: HttpInterceptorFn = (req, next) => {
  if (req.url.includes('www.primefaces.org') || req.method == 'GET') return next(req);
    ...
    /**El formato predeterminado para un body es un objeto de una sola dimensiÃ³n con las definiciones de los campos en formato JSON:
     * {
     *  key1: string,
     *  key2: string,
     *  ...
     * } 
     * Si existe mÃ¡s de un archivo, se especifican las definiciones(campos) del archivo en camnpos con la siguiente nomenclatura: 
     * file_[Ã­ndice]_[key1], file_[Ã­ndice]_[key2],... seguido del archivo con el nombre "file_[Ã­ndice]":
     * { 
     *  ...
     *  file_0: File,
     *  file_1: File
